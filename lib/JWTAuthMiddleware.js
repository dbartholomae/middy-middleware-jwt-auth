        ...
        this.before = function (_a) {
            ...
            return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    ...
                    parts = event.headers.Authorization.split(' ');
                    if (parts.length !== 2 || parts[0] !== 'Bearer') {
                        this.logger("Authorization header malformed, it was \"" + event.headers.Authorization + "\" but should be of format \"Bearer token\"");
                        throw createHttpError(401, "Format should be \"Authorization: Bearer [token]\", received \"Authorization: " + event.headers.Authorization + "\" instead", {
